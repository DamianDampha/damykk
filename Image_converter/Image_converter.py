...
# Přidáme název aplikace

label1 = tk.Label(root, text="Image Converter", bg='azure3')
label1.config(font=('helvetica', 20))
canvas1.create_window(150, 60, window=label1)

# Funkce pro načtení PNG souboru a jeho convertnutí na JPG
...
# Tlačítko pro výběr PNG souboru
...
# Funkce pro uložení JPG souboru
...
# Tlačítko pro konverzi PNG na JPG
